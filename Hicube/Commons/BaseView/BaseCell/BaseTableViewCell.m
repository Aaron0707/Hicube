...
- (void)addArrowRight {
    if (!self.arrowlayer) {
        ...
        layer.frame = CGRectMake(Main_Screen_Width - 16, (self.height - 9)/2, 6, self.height);
...
//    self.imageView.userInteractionEnabled = YES;
    ...
    self.topLineView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, Main_Screen_Width, 0.5)];
    topLineView.image =
    ...
    self.bottomLineView = [[UIImageView alloc] initWithFrame:CGRectMake(0, Main_Screen_Width - 0.5, Main_Screen_Width, 0.5)];
    self.bottomLineView.image = 
    self.bottomLineView.highlightedImage = [UIImage imageWithColor:RGBCOLOR(239, 239, 239) cornerRadius:1];
